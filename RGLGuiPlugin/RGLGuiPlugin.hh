...
namespace ignition::gui::plugins
{
  class RGLGuiPluginPrivate;
  ...
  class RGLGuiPlugin : public ignition::gui::Plugin
  {
    Q_OBJECT
    ...
    private: std::unique_ptr<RGLGuiPluginPrivate> dataPtr;
  ...
  private: ignition::rendering::VisualPtr visualPtr = nullptr;
